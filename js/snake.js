...
(function (Snake) {
    ...
    class Game {
        constructor(canvas, user_settings, onOver) {
            this.settings = defaultSettings;
            this.running = false;
            this.speed = 0;
            this.timer = 0;
            this.steering = []; //-1 => left; 1 => right
        ...
        drawScore() {
            ...
            this.ctx.fillText(this.player.segments.length.toString(), this.settings.block_resolution / 2, this.settings.block_resolution / 2);
        }
        drawHelp() {
